...
const sliderImages = ["../2020/img/ai-for-others/ai_for_others_artwork_0.jpg", "../2020/img/ai-for-others/ai_for_others_artwork_1.jpg", "../2020/img/ai-for-others/ai_for_others_artwork_2.jpg", "/img/2022/The_Almost/4.jpg", "../2020/img/ai-for-others/ai_for_others_artwork_3.jpg"]
const imageLoaded = sliderImages.map(function(image, i) {
    ...
    sliderImages.length === 1 ? gsap.set('.button-container, .gallery-list__progress-bar', { display: 'none' }) : '';
    ...
    sliderElem.setAttribute("src", image);
